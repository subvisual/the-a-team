...
- Does the target project have a design system / component library, and where
  ...
  and current.)
- Are there brand constraints — palette, type, tone — the lo-fi and spec must
  respect, or is this a clean-slate exploration?
...
- Are there existing screens/patterns in the product this feature must feel
  consistent with?
- Any accessibility or platform requirements (mobile-first, keyboard-only,
  localization) that shape layout decisions?
